...
QScriptValue qtscript_create_QComboBox_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 33; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QComboBox_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QComboBox_static_call, proto, function_lengths[0]);
