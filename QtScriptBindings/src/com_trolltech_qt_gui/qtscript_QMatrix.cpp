...
QScriptValue qtscript_create_QMatrix_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 25; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QMatrix_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QMatrix_static_call, proto, function_lengths[0]);
