...
QScriptValue qtscript_create_QTreeWidget_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 32; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QTreeWidget_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QTreeWidget_static_call, proto, function_lengths[0]);
