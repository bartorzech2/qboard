...
QScriptValue qtscript_create_QRadioButton_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 2; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QRadioButton_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QRadioButton_static_call, proto, function_lengths[0]);
