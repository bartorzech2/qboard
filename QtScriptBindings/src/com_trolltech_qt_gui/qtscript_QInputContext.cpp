...
QScriptValue qtscript_create_QInputContext_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 14; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QInputContext_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QInputContext_static_call, proto, function_lengths[0]);
