...
static QScriptValue qtscript_QStyleOption_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    case 1: {
    QString result = QString::fromLatin1("QStyleOption");
...
QScriptValue qtscript_create_QStyleOption_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 2; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QStyleOption_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QStyleOption_static_call, proto, function_lengths[0]);
