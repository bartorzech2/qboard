...
QScriptValue qtscript_create_QTableView_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 22; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QTableView_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QTableView_static_call, proto, function_lengths[0]);
