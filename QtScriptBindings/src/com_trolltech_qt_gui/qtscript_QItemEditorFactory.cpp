...
QScriptValue qtscript_create_QItemEditorFactory_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 4; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QItemEditorFactory_prototype_call, function_lengths[i+3]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QItemEditorFactory_static_call, proto, function_lengths[0]);
