...
QScriptValue qtscript_create_QDoubleSpinBox_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 4; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QDoubleSpinBox_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QDoubleSpinBox_static_call, proto, function_lengths[0]);
