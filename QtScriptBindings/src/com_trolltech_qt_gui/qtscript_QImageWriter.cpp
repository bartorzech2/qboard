...
QScriptValue qtscript_create_QImageWriter_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 19; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QImageWriter_prototype_call, function_lengths[i+2]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QImageWriter_static_call, proto, function_lengths[0]);
