...
QScriptValue qtscript_create_QSqlDriverCreatorBase_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 2; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QSqlDriverCreatorBase_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QSqlDriverCreatorBase_static_call, proto, function_lengths[0]);
