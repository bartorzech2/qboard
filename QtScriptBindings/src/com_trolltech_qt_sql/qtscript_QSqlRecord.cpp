...
QScriptValue qtscript_create_QSqlRecord_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 20; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QSqlRecord_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QSqlRecord_static_call, proto, function_lengths[0]);
