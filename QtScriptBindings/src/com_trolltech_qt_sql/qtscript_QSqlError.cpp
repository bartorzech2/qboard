...
QScriptValue qtscript_create_QSqlError_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 11; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QSqlError_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QSqlError_static_call, proto, function_lengths[0]);
