...
QScriptValue qtscript_create_QSqlRelation_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 5; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QSqlRelation_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QSqlRelation_static_call, proto, function_lengths[0]);
