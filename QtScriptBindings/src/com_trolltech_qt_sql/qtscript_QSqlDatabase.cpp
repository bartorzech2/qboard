...
QScriptValue qtscript_create_QSqlDatabase_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 29; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QSqlDatabase_prototype_call, function_lengths[i+10]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QSqlDatabase_static_call, proto, function_lengths[0]);
