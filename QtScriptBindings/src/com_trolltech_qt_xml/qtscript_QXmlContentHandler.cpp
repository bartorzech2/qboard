...
QScriptValue qtscript_create_QXmlContentHandler_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 13; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QXmlContentHandler_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QXmlContentHandler_static_call, proto, function_lengths[0]);
