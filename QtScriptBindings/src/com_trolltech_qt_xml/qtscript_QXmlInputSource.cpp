...
QScriptValue qtscript_create_QXmlInputSource_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 6; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QXmlInputSource_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QXmlInputSource_static_call, proto, function_lengths[0]);
