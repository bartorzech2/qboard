...
QScriptValue qtscript_create_QDomCharacterData_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 9; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QDomCharacterData_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QDomCharacterData_static_call, proto, function_lengths[0]);
