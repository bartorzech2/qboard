...
QScriptValue qtscript_create_QSvgWidget_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 3; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QSvgWidget_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QSvgWidget_static_call, proto, function_lengths[0]);
