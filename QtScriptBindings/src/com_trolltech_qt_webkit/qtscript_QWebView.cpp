...
QScriptValue qtscript_create_QWebView_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 12; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QWebView_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QWebView_static_call, proto, function_lengths[0]);
