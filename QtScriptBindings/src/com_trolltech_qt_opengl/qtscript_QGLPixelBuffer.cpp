...
QScriptValue qtscript_create_QGLPixelBuffer_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 9; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QGLPixelBuffer_prototype_call, function_lengths[i+2]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QGLPixelBuffer_static_call, proto, function_lengths[0]);
