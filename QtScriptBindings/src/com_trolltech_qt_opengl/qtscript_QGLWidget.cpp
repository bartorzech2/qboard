...
QScriptValue qtscript_create_QGLWidget_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 18; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QGLWidget_prototype_call, function_lengths[i+2]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QGLWidget_static_call, proto, function_lengths[0]);
