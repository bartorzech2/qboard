...
QScriptValue qtscript_create_QSourceLocation_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 9; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QSourceLocation_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QSourceLocation_static_call, proto, function_lengths[0]);
