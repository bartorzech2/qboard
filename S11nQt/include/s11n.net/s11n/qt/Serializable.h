#ifndef __S11N_NET_S11N_QT_SERIALIZABLE_H_INCLUDED__
#define __S11N_NET_S11N_QT_SERIALIZABLE_H_INCLUDED__
/*
...
namespace s11n {
    ...
    struct s11n_traits < SubT, ::s11n::qt::Serializable >
    {
	typedef SubT serializable_type;
	typedef ::s11n::qt::Serializable serializable_interface_type;
	typedef ::s11n::qt::Serializable_s11n serialize_functor;
	typedef ::s11n::qt::Serializable_s11n deserialize_functor;
...
#define S11N_FACREG_TYPE s11n::qt::Serializable
#define S11N_FACREG_TYPE_NAME "Serializable"
#define S11N_FACREG_INTERFACE_TYPE s11n::qt::Serializable
#define S11N_FACREG_TYPE_IS_ABSTRACT 1
#include <s11n.net/s11n/factory_reg.hpp>

#endif // __S11N_NET_S11N_QT_SERIALIZABLE_H_INCLUDED__
