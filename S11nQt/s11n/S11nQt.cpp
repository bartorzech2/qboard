...
#include <s11n.net/s11n/proxy/qt/QBitArray.h>
#include <s11n.net/s11n/proxy/qt/QBrush.h>
#include <s11n.net/s11n/proxy/qt/QByteArray.h>
#include <s11n.net/s11n/proxy/qt/QColor.h>
#include <s11n.net/s11n/proxy/qt/QDate.h>
#include <s11n.net/s11n/proxy/qt/QDateTime.h>
#include <s11n.net/s11n/proxy/qt/QFont.h>
#include <s11n.net/s11n/proxy/qt/QLine.h>
#include <s11n.net/s11n/proxy/qt/QLineF.h>
#include <s11n.net/s11n/proxy/qt/QList.h>
#include <s11n.net/s11n/proxy/qt/QMap.h>
#include <s11n.net/s11n/proxy/qt/QMatrix.h>
#include <s11n.net/s11n/proxy/qt/QPair.h>
#include <s11n.net/s11n/proxy/qt/QPen.h>
#include <s11n.net/s11n/proxy/qt/QPixmap.h>
#include <s11n.net/s11n/proxy/qt/QPoint.h>
#include <s11n.net/s11n/proxy/qt/QPointF.h>
#include <s11n.net/s11n/proxy/qt/QRect.h>
#include <s11n.net/s11n/proxy/qt/QRectF.h>
#include <s11n.net/s11n/proxy/qt/QRegExp.h>
#include <s11n.net/s11n/proxy/qt/QSize.h>
#include <s11n.net/s11n/proxy/qt/QSizeF.h>
#include <s11n.net/s11n/proxy/qt/QString.h>
#include <s11n.net/s11n/proxy/qt/QStringList.h>
#include <s11n.net/s11n/proxy/qt/QTime.h>
#include <s11n.net/s11n/proxy/qt/QTransform.h>
#include <s11n.net/s11n/proxy/qt/QVariant.h>

namespace s11n { namespace qt {

const int VariantS11n::registration = VariantS11n::variantType();

Qt::PenStyle stringToPenStyle( QString const &val )
{
...
Qt::BrushStyle stringToBrushStyle( QString const &val )
{
...
QString brushStyleToString( int i )
{
    typedef QMap<int,QString> MapT;
    static MapT bob;
    if( bob.isEmpty() )
...
bool QBrush_s11n::operator()(S11nNode & dest, QBrush const & src ) const
{
    typedef s11nlite::node_traits NT;
    NT::set( dest, "style",
	     brushStyleToString(src.style()).toAscii().constData() );
    bool ret = true;
...
bool QBrush_s11n::operator()( S11nNode const & src, QBrush & dest ) const
{
	...
	QBrush bogo;
	{
	    ...
	    bogo.setStyle( stringToBrushStyle(sty) );
	}
	S11nNode const * ch = 0;
#define DESER(T,N,X) \
...
{
    typedef S11nNodeTraits NT;
    NT::set(dest,"style", penStyleToString(src.style()).toAscii().constData() );
...
bool QPen_s11n::operator()( S11nNode const & src, QPen & dest ) const
{
    ...
    typedef S11nNodeTraits NT;
    tmp.setStyle( stringToPenStyle( NT::get(src,"style", std::string("NoPen")).c_str() ) );
...
char const * VariantS11n::variantTypeName()
{
    return "VariantS11n";
}
...
VariantS11n::VariantS11n( S11nNode const & n)
    : proxy( new Detail::SharedS11nNode )
{
    proxy->node = n;
}
VariantS11n & VariantS11n::operator=( VariantS11n const & src )
{
    this->proxy = src.proxy;
    return *this;
}
VariantS11n::VariantS11n( VariantS11n const & src )
    : proxy(src.proxy)
{
}
VariantS11n::~VariantS11n()
...
bool VariantS11n::empty() const
{
    return S11nNodeTraits::empty(proxy->node);
}

S11nNode & VariantS11n::node() { return this->proxy->node; }
S11nNode const & VariantS11n::node() const { return this->proxy->node; }

void VariantS11n::clear()
{
...
#define MAP(VT) \
	...
	MAP(Url);
	MAP(UserType);
	bob[VariantS11n::variantType()] = VariantS11n::variantTypeName();
#undef MAP
 	//COUT << "vTNMap()==\n"; s11nlite::save(bob,std::cout);
    }
    return bob;
